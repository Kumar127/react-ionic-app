...
import { IonText, IonToolbar, IonContent, IonPage, IonCol, IonRow, IonIcon, IonSearchbar,
   IonRefresher, IonRefresherContent, IonToast, IonSlides, IonSlide, IonHeader, IonLabel, IonCard, IonGrid, IonImg, IonCardContent, IonList, IonItem, IonSelect, IonSelectOption, 
   } from '@ionic/react';
import './Home.scss'
...
const Men: React.FC<RouteComponentProps> = ({history}) => {
