...
import makeUp from '../Assests/make_up.jpg'
import nails from '../Assests/nails.jpg'
import {IonCard,
    IonContent,
    IonHeader,
    IonItem,
    IonLabel,
    IonPage,
    IonToolbar, IonImg, IonButtons, IonText, IonList, IonIcon, IonCardHeader, IonCardTitle, IonAvatar } from '@ionic/react';
